            ...
            >
              ...
              {modalArg.title && (
                <div className="flex items-center justify-between border-b border-gray px-4 py-3">
                  {modalArg.title && (
                    <h2 className="w-full overflow-hidden  text-ellipsis whitespace-nowrap text-xl font-semibold text-white">
                      {modalArg.title}
                    </h2>
                  )}
                  <button
              ...
              <div className="relative z-10 w-full p-3">{modalArg.body}</div>
